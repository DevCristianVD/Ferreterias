...
public class Marcas extends javax.swing.JFrame {
   ...
   DefaultTableModel modeloTabla = new DefaultTableModel();
    ...
    public Marcas() {
        initComponents();
        String[] encabezadosTabla=new String[]{"ID","Marca"};
    ...
    private void BotonActualizarCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonActualizarCActionPerformed
        ...
        if (filaSeleccionada != -1) {
            int id_parentesco = (int) TablaMarcas.getValueAt(filaSeleccionada, 0); // Obtiene ID
            String nombre = (String) TablaMarcas.getValueAt(filaSeleccionada, 1);  // Obtiene Nombre

            this.dispose();
            ActualizarMarca ACM = new ActualizarMarca(id_parentesco, nombre);
            ACM.setLocationRelativeTo(this);
            ACM.setVisible(true);
        } else {
