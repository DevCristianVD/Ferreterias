...
public class ActualizarMarca extends javax.swing.JFrame {
    ...
    public ActualizarMarca(int id, String nombre) {
        initComponents();
    ...
    private void BotonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonActualizarActionPerformed
        try {
        if (idSeleccionado <= 0) {
            javax.swing.JOptionPane.showMessageDialog(this, "Seleccione un registro válido para actualizar.");
            return;
        }
        if (nombretxt.getText().trim().isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "El campo de nombre no puede estar vacío.");
            return;
        }

        MarcaDAO marcaDAO = new MarcaDAO();
        Marca marcaActualizada = new Marca(idSeleccionado, nombretxt.getText().trim());

        if (marcaDAO.actualizarMarca(marcaActualizada)) {
