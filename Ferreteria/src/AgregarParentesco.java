...
public class AgregarParentesco extends javax.swing.JFrame {

    
    public AgregarParentesco() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        BotonGuardarP.setBackground(new java.awt.Color(255, 255, 255));
        BotonGuardarP.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        BotonGuardarP.setText("Guardar");
        BotonGuardarP.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 51), 2, true));
        BotonGuardarP.setContentAreaFilled(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(287, 287, 287)
                        .addComponent(BotonGuardarP, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(45, 45, 45)
                .addComponent(BotonGuardarP, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void BotonGuardarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGuardarPActionPerformed
       try {
        ...
        // Obtener el nuevo ID
        int nuevoCodigo = parentescoDAO.obtenerUltimoIdParentesco() + 1;

        // Crear un nuevo objeto Parentesco
        Parentesco nuevoParentesco = new Parentesco(nuevoCodigo, nombretxt.getText());

        // Insertar el nuevo parentesco
        if (parentescoDAO.insertarParentesco(nuevoParentesco)) {
            javax.swing.JOptionPane.showMessageDialog(this, "Parentesco registrado con éxito.");
            this.dispose();
            parentescoG parentescoG = new parentescoG();
            parentescoG.setLocationRelativeTo(this);
            parentescoG.setVisible(true);
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "Error al registrar parentesco.");
        }
    } catch (Exception e) {
